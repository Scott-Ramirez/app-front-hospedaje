...
export interface IAuthRepository {
  ...
  registrarUsuario(username: string, clave: string, nombre: string, rol: RolUsuario, horaInicioTurno?: string | null, horaFinTurno?: string | null): Promise<any>;
  actualizarUsuario(id: number, nombre: string, rol: RolUsuario, horaInicioTurno?: string | null, horaFinTurno?: string | null): Promise<any>;
